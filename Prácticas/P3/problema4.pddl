...
(define (problem ej4)
    ...
    (:goal
        ...
        ; vespeno, con el que posteriormente se construirá unos barracones (Barracones1) donde se
        ; reclutarán estas unidades militares. En este ejercicio, los barracones (Barracones1) se deben
        ; construir en la localización LOC32. 
        (and
            ; MARINE 1
