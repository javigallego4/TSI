...
(define (problem ej5)
    ...
    (:init
        ...
        ; NUEVO
        ; En el estado inicial del problema asignamos el 0 al valor del coste del plan. 
        (= (costePlan) 0)
    ...
    (:goal
        (and
            ...
            ; NUEVO: tenemos que minimizar el coste del plan. Realizamos una comparacion de forma iterativa. 
            ; !! Las acciones empiezan en 0 !!
            (<
                (costePlan)
                25
            )
